...
//   return v;
//}
static inline precision pnew(precision u) { return u; }
static inline void      pdestroy(precision u) {}
static inline precision pparmq(precision u) { return u; }
static inline precision presult(precision u) { return u; }
static inline precision psetq(precision *up, precision v) {
   precision u = *up;
   *up = v;
   return v;
